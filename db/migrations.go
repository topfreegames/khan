...
func migrations20160608133902_creategametableSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/20160608133902_CreateGameTable.sql", size: 1150, mode: os.FileMode(420), modTime: time.Unix(1466707165, 0)}
...
func migrations20160608182307_createmembershiptableSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations/20160608182307_CreateMembershipTable.sql", size: 1018, mode: os.FileMode(420), modTime: time.Unix(1466787722, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
