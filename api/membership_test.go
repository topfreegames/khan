...
func TestMembershipHandler(t *testing.T) {
	...
	g.Describe("Apply For Membership Handler", func() {
		g.It("Should create membership", func() {
			...
			res := PostJSON(a, CreateMembershipRoute(gameID, clanPublicID, "memberships/apply"), t, payload)
			...
			dbMembership, err := models.GetMembershipByPlayerPublicID(a.Db, gameID, player.PublicID)
			g.Assert(err == nil).IsTrue()
		...
		g.It("Should not create membership if invalid payload", func() {
			...
			res := PostBody(a, CreateMembershipRoute(gameID, clanPublicID, "memberships/apply"), t, "invalid")
	...
	g.Describe("Invite For Membership Handler", func() {
		g.It("Should create membership if clan owner", func() {
			...
			res := PostJSON(a, CreateMembershipRoute(gameID, clanPublicID, "memberships/invite"), t, payload)
		...
		g.It("Should not create membership if invalid payload", func() {
			...
			res := PostBody(a, CreateMembershipRoute(gameID, clanPublicID, "memberships/invite"), t, "invalid")
